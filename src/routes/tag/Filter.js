  ...
  return (
    <Row gutter={24}>
        ...
        <Col {...ColProps} xl={{ span: 3 }} md={{ span: 5 }}>
          {getFieldDecorator('name', { initialValue: name })(<Search placeholder="搜索标签名称" size="large" onSearch={handleSubmit} />)}
        </Col>
        <Col {...ColProps} xl={{ span: 3 }} md={{ span: 5 }}>
        ...
        <Col {...ColProps} xl={{ span: 3 }} md={{ span: 5 }}>
         {getFieldDecorator('catId', { initialValue: catId })(
             <Select
                 showSearch
                 style={{ width: '100%' }}
                 placeholder="选择一个标签类别"
                //  optionFilterProp="children"
                  onChange={handleChange.bind(null, 'catId')}
